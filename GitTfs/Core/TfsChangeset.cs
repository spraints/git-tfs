...
namespace Sep.Git.Tfs.Core
{
    public class TfsChangeset : ITfsChangeset
    {
        ...
        private void Apply(ApplicableChange change, IGitTreeBuilder treeBuilder, ITfsWorkspace workspace, IGitTreeInformation initialTree)
        {
            switch (change.Type)
            {
        ...
        private void Update(ApplicableChange change, IGitTreeBuilder treeBuilder, ITfsWorkspace workspace, IGitTreeInformation initialTree)
        {
        ...
        {
            var treeInfo = Summary.Remote.Repository.GetObjects(null);
